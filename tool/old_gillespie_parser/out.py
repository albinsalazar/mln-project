...
def run_sim(model):
	...
	for i in range(len(trajectory["AI0"])):
		trajectories[0].append(trajectory["AI1"][i] + trajectory["AI0"][i] + trajectory["AI2"][i])
		trajectories[1].append(trajectory["AS1"][i] + trajectory["AS0"][i] + trajectory["AS2"][i])
		trajectories[2].append(trajectory["US1"][i] + trajectory["US0"][i] + trajectory["US2"][i])
