...
def run_sim(model):
	...
	for i in range(len(trajectory["AI0"])):
		trajectories[0].append(trajectory["AI2"][i] + trajectory["AI1"][i] + trajectory["AI0"][i])
		trajectories[1].append(trajectory["AS2"][i] + trajectory["AS1"][i] + trajectory["AS0"][i])
		trajectories[2].append(trajectory["US2"][i] + trajectory["US1"][i] + trajectory["US0"][i])
