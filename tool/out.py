...
class Mln_dynamics(Model):
	def __init__(self,parameter_values=None):
		...
		self.timespan(numpy.linspace(0, 80, 1600))
...
def run_sim(model):
	...
	for i in range(len(trajectory["AI0"])):
		trajectories[0].append(trajectory["AI0"][i] + trajectory["AI3"][i] + trajectory["AI2"][i] + trajectory["AI1"][i])
		trajectories[1].append(trajectory["AS0"][i] + trajectory["AS3"][i] + trajectory["AS2"][i] + trajectory["AS1"][i])
		trajectories[2].append(trajectory["US0"][i] + trajectory["US3"][i] + trajectory["US2"][i] + trajectory["US1"][i])
